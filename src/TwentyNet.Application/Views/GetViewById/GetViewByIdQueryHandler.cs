...
public sealed class GetViewByIdQueryHandler : IRequestHandler<GetViewByIdQuery, ViewDto?>
{
    ...
    public GetViewByIdQueryHandler(
    ...
    public async Task<ViewDto?> Handle(GetViewByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return _mapper.Map<ViewDto>(view) with
        {
